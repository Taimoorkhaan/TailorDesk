...
public class AddCustomerMember extends AppCompatActivity {
    ...
    private Spinner genderSpinner,memberRelationSpinner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_customer_member);
        ...
        selectDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (view == selectDate) {
                    ...
                    final DatePickerDialog datePickerDialog = new DatePickerDialog(AddCustomerMember.this,R.style.DialogTheme,
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(AddCustomerMember.this,CustomerHomeActivity.class);
        ...
        facePicture.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Dexter.withContext(AddCustomerMember.this)
                        ...
                        .withListener(new PermissionListener() {
                            ...
                            public void onPermissionGranted(PermissionGrantedResponse permissionGrantedResponse) {
                                ...
                                CroperinoFileUtil.verifyStoragePermissions(AddCustomerMember.this);
                                CroperinoFileUtil.setupDirectory(AddCustomerMember.this);

                                activeImage="facePicture";
                                activeUri=facePictureUri;
                                Croperino.prepareChooser(AddCustomerMember.this, "Select Image", ContextCompat.getColor(AddCustomerMember.this, android.R.color.background_dark));
                       /* Intent intent=new Intent(MainActivity.this,MapTraining.class);
                        ...
                        finish();*/
                            ...
                            public void onPermissionDenied(PermissionDeniedResponse permissionDeniedResponse) {
                                ...
                                AlertDialog builder = new AlertDialog.Builder(AddCustomerMember.this)
        ...
        saveCustomerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(customerName.getText().toString().isEmpty()){
                    Toast.makeText(AddCustomerMember.this, "Kindly Enter Your Customer Name", Toast.LENGTH_SHORT).show();
                    return;
                }

                if(customerNumber.getText().toString().isEmpty()){
                    Toast.makeText(AddCustomerMember.this, "Kindly Enter Your Customer Number", Toast.LENGTH_SHORT).show();
                    return;
                }

                if(!Pattern.matches("(03)+[0-6]{2}[0-9]{7}", customerNumber.getText().toString())){
              ...
              /*  if(customerEmail.getText().toString().isEmpty()){
                    Toast.makeText(AddCustomer.this, "Kindly Enter Your Customer Email", Toast.LENGTH_SHORT).show();
                    return;
                }*/

                if(genderSpinner.getSelectedItemPosition()==0){
                    Toast.makeText(AddCustomerMember.this, "Kindly select Gender", Toast.LENGTH_SHORT).show();
                    return;
                }
              ...
              /*  if(facePictureUri==null){
                ...
                try {
                    customerDetailsObj.put("CustomerName",customerName.getText().toString());
                    customerDetailsObj.put("CustomerPhoneNo",customerNumber.getText().toString());
        ...
        switch (requestCode) {
            ...
            case CroperinoConfig.REQUEST_CROP_PHOTO:
                if (resultCode == Activity.RESULT_OK) {
                  ...
                  /*  logo_text.setText(bodyPictureUri.getLastPathSegment());
                    tailorPicture = facePictureUri.getLastPathSegment().toString();*/
                  /*  profileImageName = lawyerProfileImageURI.getLastPathSegment().toString();
                    profilePicName.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
                    //    ProfileImgUri = i;
   ...
   /* public void cearteCustomer() {
                ...
                if (response != null) {
                    ...
                    if (response.toString().equalsIgnoreCase("Invalid Data")) {
                        ...
                        *//*editor.putString("Signup", "yes");
                        ...
                        Toast.makeText(AddCustomer.this, "Data Uploaded Successfully"+response.toString(), Toast.LENGTH_LONG).show();
    ...
    //TailorGetApi/CustomerExist?PhoneNo=923082012212&TailorShopId=1
}