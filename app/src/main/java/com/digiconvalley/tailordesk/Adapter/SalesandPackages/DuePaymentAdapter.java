...
public class DuePaymentAdapter extends RecyclerView.Adapter<DuePaymentAdapter.viewHolder> {

    Context context;
    List<MainDuePayment> arrayList;

    public DuePaymentAdapter(Context context, List<MainDuePayment> arrayList) {
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.due_payment, parent, false);
...
//        holder.order_adanceP.setText(arrayList.get(position).getOrder_advanceP());
        holder.order_advaceRs.setText(String.valueOf(arrayList.get(position).getRemainingAmount()));
