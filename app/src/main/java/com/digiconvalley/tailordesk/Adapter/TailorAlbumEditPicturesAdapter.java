...
public class TailorAlbumEditPicturesAdapter extends RecyclerView.Adapter<TailorAlbumEditPicturesAdapter.ViewHolder> {
    private Context context;
    private ArrayList<AlbumDesigns> albumDesigns;
    private Albums albums;
    private Boolean deleteAlbumStatus=false;

    public TailorAlbumEditPicturesAdapter(Context context, ArrayList<AlbumDesigns> albumDesigns) {
        this.context = context;
        this.albumDesigns = albumDesigns;
    }


    public TailorAlbumEditPicturesAdapter(Context context, ArrayList<AlbumDesigns> albumDesigns, Albums albums) {
        this.context = context;
        this.albumDesigns = albumDesigns;
        this.albums = albums;
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void OnBindData(final AlbumDesigns albumDesigns, final Integer index){
            ...
            if(albumDesigns.getAlbumDesignId()!=null){
